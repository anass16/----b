...
const Legend = () => (
  <div className="flex items-center justify-center space-x-4 mt-4 text-xs text-gray-600 dark:text-gray-400">
    <div className="flex items-center"><div className="w-3 h-3 rounded-sm bg-gray-200 dark:bg-gray-700 mr-1"></div>No Data</div>
    <div className="flex items-center"><div className="w-3 h-3 rounded-sm bg-green-500 mr-1"></div>Worked</div>
    <div className="flex items-center"><div className="w-3 h-3 rounded-sm bg-red-500 mr-1"></div>Absent</div>
    <div className="flex items-center"><div className="w-3 h-3 rounded-sm bg-blue-500 mr-1"></div>Holiday Worked</div>
  </div>
);
...
export function AttendanceHeatmap({ matricule }: AttendanceHeatmapProps) {
  ...
  const changeMonth = (amount: number) => {
    ...
    setCurrentDate(new Date(newDate)); // Create a new Date object to trigger re-render
  };
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="w-32 text-center font-semibold">{getMonthName(currentDate)}</span>
